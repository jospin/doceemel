<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TipoTelefone.aspx.vb" Inherits="Estoque.TipoTelefone" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table3" style="Z-INDEX: 108; LEFT: 336px; WIDTH: 96px; POSITION: absolute; TOP: 176px; HEIGHT: 40px"
						...
						<TABLE class="label" id="Table5" style="WIDTH: 328px; HEIGHT: 49px" cellSpacing="1" cellPadding="1"
							...
							<TR>
								...
								<TD><STRONG>Tipo de Telefone</STRONG>&nbsp;
									<asp:RequiredFieldValidator id="rfvNome" runat="server" ControlToValidate="txtTipoTel" ErrorMessage="Tipo">*</asp:RequiredFieldValidator></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 46px">
									<asp:textbox id="txtCodTipoTel" runat="server" CssClass="texto" Width="40px" Enabled="False"
										Font-Size="X-Small" Font-Names="Trebuchet MS"></asp:textbox></TD>
								<TD>
									<asp:textbox id="txtTipoTel" runat="server" CssClass="texto" Width="272px" Font-Size="X-Small"
				...
				<TR>
					<TD>
						<asp:datagrid id="DataGrid1" runat="server" Width="368px" AllowPaging="True" PageSize="12" ShowFooter="True"
							...
							<Columns>
								<asp:BoundColumn DataField="codTipoTel" HeaderText="C&#243;digo"></asp:BoundColumn>
								<asp:ButtonColumn DataTextField="tipoTel" HeaderText="Tipo de Telefone" CommandName="Select"></asp:ButtonColumn>
								<asp:BoundColumn Visible="False" DataField="tipoTel" HeaderText="Tipo deTelefone"></asp:BoundColumn>
							</Columns>
