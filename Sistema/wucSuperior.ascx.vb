...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents lnkCadastros1 As System.Web.UI.WebControls.LinkButton
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load   'Testar
    ...
    Private Sub limparUnderlines()
        ...
        Me.lnkCadastros1.Font.Bold = False
    ...
    Private Sub lnkSistema_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lnkSistema.Click
        Response.Redirect("principal.aspx?contexto=1")

    End Sub

    Private Sub lnkCadastros_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Response.Redirect("principal.aspx?contexto=2")

    End Sub

    Private Sub lnkMovimentos_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lnkMovimentos.Click
        Response.Redirect("principal.aspx?contexto=3")
    End Sub

    Private Sub lnkSeguranca_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lnkSeguranca.Click
        Response.Redirect("principal.aspx?contexto=4")
    End Sub
    ...
    Private Sub grifar(ByVal contexto As String)
        Select Case contexto
            ...
            Case Is = 2
                Me.lnkCadastros1.Font.Bold = True
            Case Is = 3
    ...
    Private Sub lnkCadastros1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lnkCadastros1.Click
        Response.Redirect("principal.aspx?contexto=2")
    End Sub

    Private Sub lnkRelatorios_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lnkRelatorios.Click
        Response.Redirect("principal.aspx?contexto=5")
    End Sub
End Class
