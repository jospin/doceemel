...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CatProduto.aspx.vb" Inherits="Estoque.CatProduto" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table3" style="Z-INDEX: 104; LEFT: 344px; WIDTH: 96px; POSITION: absolute; TOP: 176px; HEIGHT: 40px"
				...
				<TR>
					<TD>
						<TABLE class="label" id="Table5" style="WIDTH: 328px; HEIGHT: 49px" cellSpacing="1" cellPadding="1"
							...
							<TR>
								...
								<TD><STRONG>Nome</STRONG>
									<asp:RequiredFieldValidator id="rfvNome" runat="server" ControlToValidate="txtNomeCatProd" ErrorMessage="Nome da Categoria">*</asp:RequiredFieldValidator></TD>
								<TD>Preço</TD>
							</TR>
							<TR>
								<TD style="WIDTH: 46px">
									<asp:textbox id="txtCodCatProd" runat="server" CssClass="texto" Width="40px" Enabled="False"
										Font-Size="X-Small" Font-Names="Trebuchet MS"></asp:textbox></TD>
								<TD>
									<asp:textbox id="txtNomeCatProd" runat="server" CssClass="texto" Width="208px" Font-Size="X-Small"
										Font-Names="Trebuchet MS"></asp:textbox></TD>
								<TD>
									<asp:textbox id="txtPreco" runat="server" CssClass="texto" Font-Names="Trebuchet MS" Font-Size="X-Small"
						...
						<TABLE class="label" id="Table2" style="WIDTH: 328px; HEIGHT: 49px" cellSpacing="1" cellPadding="1"
							...
							<TR>
								<TD>
									<asp:textbox id="txtObsCatProd" runat="server" CssClass="texto" Font-Names="Trebuchet MS" Font-Size="X-Small"
										Width="352px" Height="64px" TextMode="MultiLine"></asp:textbox></TD>
							</TR>
						</TABLE>
				...
				<TR>
					<TD>
						<asp:datagrid id="DataGrid1" runat="server" Width="360px" AllowPaging="True" PageSize="12" ShowFooter="True"
							...
							<Columns>
								<asp:BoundColumn DataField="codCatProd" HeaderText="C&#243;digo"></asp:BoundColumn>
								<asp:ButtonColumn DataTextField="nomeCatProd" HeaderText="Nome da Categoria" CommandName="Select"></asp:ButtonColumn>
								<asp:BoundColumn DataField="preco" HeaderText="Pre&#231;o" DataFormatString="{0:C}"></asp:BoundColumn>
								<asp:BoundColumn Visible="False" DataField="nomeCatProd" HeaderText="Nome da Categoria"></asp:BoundColumn>
							</Columns>
