...
<TABLE id="Table1" style="WIDTH: 872px; HEIGHT: 96px" cellSpacing="1" cellPadding="1" width="872">
	<TR>
		<TD style="VERTICAL-ALIGN: super; WIDTH: 34px; HEIGHT: 35px" vAlign="top">
			<asp:Image id="Image1" runat="server" ImageUrl="images\ArtfixLogo_RGB(menor)1.jpg"></asp:Image></TD>
		<TD style="WIDTH: 34px; HEIGHT: 35px" vAlign="middle" colSpan="3">
			<TABLE class="MenuPrincipal" id="Table2" style="WIDTH: 664px; HEIGHT: 54px" borderColor="#ffffff"
				...
				border="20">
				<TR>
					<TD style="WIDTH: 209px" vAlign="middle" bgColor="whitesmoke"><IMG class="Bolinha" alt="" src="images/blackball.gif" align="middle" border="0">&nbsp;
					...
					<TD style="WIDTH: 217px" bgColor="whitesmoke"><IMG class="Bolinha" alt="" src="images/blackball.gif" border="0">&nbsp;
						<asp:LinkButton id="lnkCadastros" runat="server" CommandArgument="2" Font-Size="X-Small" CssClass="LinkMenuPrin"
							Width="40px" CausesValidation="False">Cadastros</asp:LinkButton></TD>
	...
	<TR>
		<TD style="VERTICAL-ALIGN: super; WIDTH: 34px; HEIGHT: 12px" vAlign="top"></TD>
	...
	<TR>
		<TD style="VERTICAL-ALIGN: super; WIDTH: 486px; HEIGHT: 8px" vAlign="top" bgColor="#026568"
			colSpan="4"></TD>
	</TR>
</TABLE>
