...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CatCliente.aspx.vb" Inherits="Estoque.CatCliente" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table3" style="Z-INDEX: 108; LEFT: 336px; WIDTH: 96px; POSITION: absolute; TOP: 192px; HEIGHT: 40px"
				...
				<TR>
					<TD>
						<TABLE class="label" id="Table5" style="WIDTH: 328px; HEIGHT: 49px" cellSpacing="1" cellPadding="1"
							...
							<TR>
								...
								<TD><STRONG>Nome</STRONG>
									<asp:RequiredFieldValidator id="rfvNome" runat="server" ControlToValidate="txtNomeCatCli" ErrorMessage="Nome">*</asp:RequiredFieldValidator></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 46px">
									<asp:textbox id="txtCodCatCli" runat="server" CssClass="texto" Width="40px" Enabled="False" Font-Size="X-Small"
										Font-Names="Trebuchet MS"></asp:textbox></TD>
								<TD>
									<asp:textbox id="txtNomeCatCli" runat="server" CssClass="texto" Width="316px" Font-Size="X-Small"
										Font-Names="Trebuchet MS"></asp:textbox></TD>
							</TR>
						</TABLE>
						<TABLE class="label" id="Table2" style="WIDTH: 328px; HEIGHT: 49px" cellSpacing="1" cellPadding="1"
							...
							<TR>
								<TD>
									<asp:textbox id="txtObsCatCli" tabIndex="3" runat="server" CssClass="texto" Width="360px" Font-Size="X-Small"
										Font-Names="Trebuchet MS" Height="56px" TextMode="MultiLine"></asp:textbox></TD>
							</TR>
						</TABLE>
				...
				<TR>
					<TD>
						<asp:datagrid id="DataGrid1" runat="server" Width="360px" AllowPaging="True" PageSize="7" ShowFooter="True"
							...
							<Columns>
								<asp:BoundColumn DataField="codCatCli" HeaderText="C&#243;digo"></asp:BoundColumn>
								<asp:ButtonColumn DataTextField="nomeCatCli" HeaderText="Nome da Categoria" CommandName="Select"></asp:ButtonColumn>
								<asp:BoundColumn Visible="False" DataField="nomeCatCli" HeaderText="NomeCatCli"></asp:BoundColumn>
							</Columns>
